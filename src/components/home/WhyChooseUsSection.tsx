...
const Feature = ({ icon, title, description, delay }: FeatureProps) => (
  <div className="flex items-start animate-slide-in" style={{ animationDelay: `${delay}s` }}>
    <div className="flex-shrink-0 mr-4">
      <div className="flex items-center justify-center w-12 h-12 rounded-lg bg-turquoise/10">
        {icon}
      </div>
    </div>
    <div>
...
const WhyChooseUsSection = () => {
  ...
  return (
    <section className="py-20 bg-lighter-navy">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-off-white mb-4 animate-fade-in">Why Choose Us</h2>
