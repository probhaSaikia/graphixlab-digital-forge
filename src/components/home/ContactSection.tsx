...
const ContactSection = () => {
  ...
  return (
    <section className="py-16 md:py-20 bg-black relative border-t border-electric-blue/20">
      {/* WhatsApp Button */}
      <WhatsAppButton />
      ...
      <div className="absolute top-0 left-0 w-full h-full opacity-20 overflow-hidden pointer-events-none">
        <div 
          className="absolute top-1/4 left-1/2 transform -translate-x-1/2 w-72 md:w-96 h-72 md:h-96 rounded-full bg-electric-blue/10 blur-3xl"
        ></div>
        {!isMobile && (
          <div 
            className="absolute bottom-1/3 right-1/4 w-48 md:w-64 h-48 md:h-64 rounded-full bg-neon-pink/10 blur-3xl"
          ></div>
        )}
      </div>
